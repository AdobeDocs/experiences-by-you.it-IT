...
Secondo [[!DNL Adobe]](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/attribution/overview.html?lang=en), *attribution* consente agli analisti di personalizzare il modo in cui *elementi Dimension* ricevono credito per *eventi di successo*.
